...
// same-origin, the public Optimism RPC used by the opt-in build
// verification, the endpoints referenced by the w3pk library,
// unpkg.com (getCurrentBuildHash() fetches the published package from there
// to compute the hash it verifies against the onchain registry), and
// raw.githubusercontent.com (the homepage fetches the Awesome Ethereum
// README directly from GitHub).
...
const contentSecurityPolicy = [
  ...
  "font-src 'self'",
  "connect-src 'self' https://mainnet.optimism.io https://chainid.network https://rukh.w3hc.org https://unpkg.com https://raw.githubusercontent.com",
